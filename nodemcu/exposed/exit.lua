...
print("EXIT: going to sleep in "..rtcmem.read32(MEMSLOT_SLEEP_DELAY).." seconds at "..tostring(sec))
gpio.write(4, 1)
...
if sec >= rtcmem.read32(MEMSLOT_NEXT_INIT_TIME) or rtcmem.read32(MEMSLOT_ENTRYS_SINCE_INIT) >= rtcmem.read32(MEMSLOT_MAX_ENTRYS_WITHOUT_INIT) then
